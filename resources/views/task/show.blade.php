<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 p-4 bg-white shadow-md">
            <p class='font-semibold text-slate-400 italic text-end mb-2' title='время создания'><?=$task->created_at?></p>
            ...
            @endif
            <p class='mb-2'><span>Последняя активность: </span> <?=$task->updated_at?></p>
        </div>
    </div>
</x-app-layout>